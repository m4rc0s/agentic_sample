...
```text
Este é um workspace Liquid v1 recém-inicializado. Leia todos os arquivos de governança na raiz (index.md, architecture.md, techinal_deal.md, product_vision.md) para assimilar o domínio deste produto. Confirme assim que estiver contextualizado para começarmos a delinear nossa primeira feature de negócio.
```
...
1. **Assimilação:** O Hermes lê os arquivos da raiz e memoriza os Bounded Contexts e as "Algemas da IA" de [`techinal_deal.md`](../techinal_deal.md).
